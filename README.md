...
[![npm](https://img.shields.io/npm/v/@hishprorg/distinctio-in.svg)](https://www.npmjs.com/package/@hishprorg/distinctio-in)
[![downloads](https://img.shields.io/npm/dt/@hishprorg/distinctio-in.svg)](https://www.npmjs.com/package/@hishprorg/distinctio-in)
[![types](https://img.shields.io/npm/types/@hishprorg/distinctio-in.svg)](https://www.npmjs.com/package/@hishprorg/distinctio-in)
[![licence](https://img.shields.io/github/license/mnasyrov/@hishprorg/distinctio-in.svg)](https://github.com/hishprorg/distinctio-in/blob/master/LICENSE)
[![Coverage Status](https://coveralls.io/repos/github/mnasyrov/@hishprorg/distinctio-in/badge.svg?branch=main)](https://coveralls.io/github/mnasyrov/@hishprorg/distinctio-in?branch=main)
...
| --------------------------------------------- | ------------------------------------------ | ---------------------------------------------------------- |
| [**@hishprorg/distinctio-in**][@hishprorg/distinctio-in/docs]             | Core elements, state and effect management | [Docs][@hishprorg/distinctio-in/docs], [API][@hishprorg/distinctio-in/api]             |
| [**@hishprorg/distinctio-in-react**][@hishprorg/distinctio-in-react/docs] | Tooling for React.js                       | [Docs][@hishprorg/distinctio-in-react/docs], [API][@hishprorg/distinctio-in-react/api] |
...
```
npm install @hishprorg/distinctio-in @hishprorg/distinctio-in-react --save
```
...
import { useConst, useObservable, useQuery } from '@hishprorg/distinctio-in-react';
...
[@hishprorg/distinctio-in/docs]: packages/@hishprorg/distinctio-in/README.md
[@hishprorg/distinctio-in/api]: packages/@hishprorg/distinctio-in/docs/README.md
[@hishprorg/distinctio-in-react/docs]: packages/@hishprorg/distinctio-in-react/README.md
[@hishprorg/distinctio-in-react/api]: packages/@hishprorg/distinctio-in-react/docs/README.md
